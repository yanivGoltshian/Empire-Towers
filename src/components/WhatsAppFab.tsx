...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex items-center justify-center h-14 w-14 rounded-full bg-eco text-white shadow-lg shadow-eco/40 hover:bg-eco-dark transition animate-floaty"
    >
